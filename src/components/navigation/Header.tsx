        ...
        <>
            <header className="bg-background h-[5rem] shadow-md px-[2rem] py-[1rem] flex items-center justify-between sticky top-0  w-full border-b-2 " >
                ...
                <div className=" h-full flex items-center  w-full justify-between ">
                    <Link href="/"> <h2 className="font-extrabold tracking-tighter text-xl cursor-pointer  w-[140px] text-center dark:text-white text-black items-center h-[30px]  "> BCN FASHION </h2> </Link> 
